...
> | Read the selected-node floating UI anchor batch | [`research/liblib-canvas-batch9-2026-08-25/`](research/liblib-canvas-batch9-2026-08-25/) |
> | Read the image-editor five-state fidelity batch | [`research/liblib-canvas-batch10-2026-08-25/`](research/liblib-canvas-batch10-2026-08-25/) |
...
- [`research/liblib-canvas-batch9-2026-08-25/README.md`](research/liblib-canvas-batch9-2026-08-25/README.md) — image/video selected floating UI geometry, parented-video following, and regression contract
- [`research/liblib-canvas-batch10-2026-08-25/README.md`](research/liblib-canvas-batch10-2026-08-25/README.md) — five source image-editor states, per-node height/content contracts, and fidelity verification
...
│   └── liblibOrganize.ts         # Source-project organize topology, fallback, and viewport bounds
