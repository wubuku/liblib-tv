...
> `RUNTIME_MISSING_OR_FRAGMENTED` / `SOURCE_PARITY_UNKNOWN_OR_PARTIAL`.
>
...
- Director没有past/future、copy/paste和统一command result。
...
- typed result/reason；
- pure semantic equality；
- project snapshot commit；
- no UI rewrite；
-先迁移一个低风险command簇验证adapter。
