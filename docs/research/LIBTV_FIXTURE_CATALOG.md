...
`LIBTV-FIX-LOCAL-DIRECTOR-AUTHORITY-01` 的当前实现状态以 Batch 67-81
...
reachability、whole-project duplicate 和 durable tombstone/resource cleanup 均已有
focused pass；
