...
| `LIBTV-PAR-008` | `LOCAL-GRAPH-CONNECTION-01` + `LOCAL-GRAPH-DOCUMENT-01` + `LOCAL-SUBGRAPH-COPY-01` + `LOCAL-NODE-DATA-01` + `LOCAL-GRAPH-DELETE-01` + `LOCAL-GRAPH-ENTRYPOINT-01` + `LOCAL-DEMO/EMPTY/GROUP/DERIVED` | connection structural slice 已由 Batch 57 通过；document/copy/data/delete/entrypoint authority contracts and `VR-010..014` remain design-complete | source invalid lifecycle/Reference/domain/Option-drag/cascade/detach；runtime transport/planner/restore boundaries missing；persistence deferred |
