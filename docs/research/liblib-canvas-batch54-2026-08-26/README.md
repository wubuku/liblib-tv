...
> 状态：已完成（2026-08-26）。本批复刻当前 LibTV selected image 的
...
- [`../components/ImageElementEditMode.spec.md`](../components/ImageElementEditMode.spec.md)：
  状态、DOM、几何和生命周期合同；
- [`IMPLEMENTATION.md`](IMPLEMENTATION.md)：代码、验证、边界和提交历史；
- [`SCREENSHOT_ANALYSIS.md`](SCREENSHOT_ANALYSIS.md)：本批唯一截图识图记录；
