...
> **状态更新 (2026-09-26 晚, Batch 240 收尾)**：226-240 已全部完成推送——
> 226 右键菜单内容感知(bd06f9d4)、227 图片灯箱(cf3c1cc9)、228 视频右键极简三行(90691520)、
> 229 框选+成组工具条(22894d0f)、231 下载接通 audioUrl(1a6db3db)、232 多选拖拽+移动入撤销栈(32cbd6b2)、
> 233 源站新鲜度扫描(ae0c3903)、235 节点搜索覆盖新类型(559c7360)、236 缩放感知替换按钮(d25b6ee1)、
> 237 缩放感知浮动标题(29c7bdd7)、238 空视频无工具条(7f8f97c6)、239 视频专属生成面板(已入库)、
> 240 视频模式 tab 采样(056e31a2)。验证基线 66/66 PASS；npm run check 0 error。
> **缩放族已闭环**：替换按钮 30px×zoom、浮动标题 12px×zoom（偏移/行高同步）、
> 浮动工具条固定 38px 不缩放（已实测）。**成组点击与宫格切分为潜在付费/未采样动作，
> 克隆保持 mock，采样时永不可点击。**
