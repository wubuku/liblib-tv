...
| 63 | actual React Flow host center placement for default node creation | [`liblib-canvas-batch63-2026-08-27/`](liblib-canvas-batch63-2026-08-27/) `PLAN_RECORDED`，计划将 Add Node 与 Character Library 的默认创建从 browser window center 迁移到实际 React Flow host center；derived/duplicate/organize、live/stable viewport 和 source-exact add policy 保持后续 |
