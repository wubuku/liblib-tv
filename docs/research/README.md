...
| 77 | Director TransformControls binding regression | [`liblib-canvas-batch77-2026-08-28/`](liblib-canvas-batch77-2026-08-28/) `IN_PROGRESS`，已复现 object gizmo 错位、实际 pointer drag 零提交和 active gesture 泄漏；计划统一 object/group/path explicit attachment 并补真实 gizmo drag gate |
