...
| 78 | Director pointer cancellation and cleanup | [`liblib-canvas-batch78-2026-08-28/`](liblib-canvas-batch78-2026-08-28/) `FOCUSED_RUNTIME_RECORDED_PASS`，Curve/Phone Vcam/Timeline 的 pointercancel、blur、visibility、unmount 和 stale-pointer 防护已通过；不改变 phone runtime-only 语义，也不证明源站 Director exact DOM/CSS |
