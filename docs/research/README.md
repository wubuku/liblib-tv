...
- [`open-canvas-2026-08-26/OPEN_CANVAS_PATTERN_CARDS.md`](open-canvas-2026-08-26/OPEN_CANVAS_PATTERN_CARDS.md)：六类可迁移模式卡，覆盖几何、typed input、状态分层、subgraph identity、stale-safe result ingress 和 framework change routing，并区分上游启发、LibTV 证据和 clone 验证闸门。
