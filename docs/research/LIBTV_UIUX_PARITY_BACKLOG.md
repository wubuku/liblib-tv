...
| - | `LIBTV-PAR-016` | media output、aspect、node frame、surface rendition、measurement 与 editor-coordinate correctness | 5 | 5 | 2 | 5 | `DESIGN_FIRST`；Batch 441 Slice A（权威分类 + 冲突诊断）、Batch 442 Slice B（aspect-aware 派生帧政策，landscape fixture 保持）已关闭；Slice C/D 待实施，source ratio-diverse parity gated |
