...
| Viewport / coordinate / gesture / placement | `FOCUSED_RUNTIME_PASS` / `RUNTIME_PARTIAL` / `SOURCE_PARITY_PARTIAL` | [`LIBTV_VIEWPORT_COORDINATE_GESTURE_STATIC_AUDIT_2026-08-27.md`](LIBTV_VIEWPORT_COORDINATE_GESTURE_STATIC_AUDIT_2026-08-27.md)、[`LIBTV_VIEWPORT_COORDINATE_PLACEMENT_CONTRACT.md`](LIBTV_VIEWPORT_COORDINATE_PLACEMENT_CONTRACT.md)、[`liblib-canvas-batch63-2026-08-27/`](liblib-canvas-batch63-2026-08-27/)、Open Canvas `OC-053..060`、Batch 6/7/16/51/60、`LIBTV-VR-020` | Batch 63 已通过 actual-host default add focused slice：Add Node/Character、drawer closed/open、desktop/mobile、one history、exact selection、invalid zero mutation；live/stable split、generation/host epoch gesture owner、resize reconcile、derived/duplicate/organize composition 和 full fixture 仍未实现，exact source add/fit/resize behavior partial |
