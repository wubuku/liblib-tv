...
| Area | Specs |
|---|---|
| Shell and navigation | `TopNavBar`, `LeftSidebar`, `BottomToolbar`, `AssetManagerPanel`, `StoryboardBoard`, `AgentDrawer` |
...
| Specialized nodes | `ScriptNode`, `ScriptExecutionNode`, `TextNode`, `ShotBreakdownNode`, `VideoClipNode` |
