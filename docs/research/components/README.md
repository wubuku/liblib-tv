...
| Graph behavior | `DeletableEdge`, `StoryboardGroupNode`, [`LibTVGraphConnection.contract.md`](LibTVGraphConnection.contract.md), [`LibTVGraphDocument.contract.md`](LibTVGraphDocument.contract.md) |
