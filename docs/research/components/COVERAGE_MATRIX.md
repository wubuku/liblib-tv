...
| `ImageToolbar` | `src/components/ImageToolbar.tsx` | `ImageNode.spec.md`、[`LibTVOverlayPositioning.contract.md`](LibTVOverlayPositioning.contract.md)、[`LIBTV_IMAGE_ACTION_MATRIX.md`](../open-canvas-2026-08-26/LIBTV_IMAGE_ACTION_MATRIX.md)、Batch 51 | Batch 9 compatibility + Batch 51 geometry verifier | `COVERED_BY_PARENT` | Batch 51 已对齐 `10 + 24 * zoom` top gap；当前 source action set 仍为 `1092.5x49`，clone 旧 `900.5px` action set 另立动作状态 batch。 |
