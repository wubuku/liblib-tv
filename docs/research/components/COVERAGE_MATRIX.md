...
| `ImageToolbar` | `src/components/ImageToolbar.tsx` | `ImageNode.spec.md`、[`LibTVOverlayPositioning.contract.md`](LibTVOverlayPositioning.contract.md)、[`LIBTV_IMAGE_ACTION_MATRIX.md`](../open-canvas-2026-08-26/LIBTV_IMAGE_ACTION_MATRIX.md)、Batch 51/52 | Batch 9 compatibility + Batch 51/52 focused verifiers | `COVERED_BY_PARENT` | Batch 51 覆盖 `10 + 24 * zoom` top gap；Batch 52 已更新当前 `1092.5x49`、13 项顺序/宽度和 Preview。标注、元素编辑、旋转、图层分离、下载仍由专用批次覆盖。 |
