...
| 实施 Director 可靠性底座 | [`LIBTV_DIRECTOR_PROJECT_SESSION_AUTHORITY_CONTRACT.md`](research/LIBTV_DIRECTOR_PROJECT_SESSION_AUTHORITY_CONTRACT.md)、[`LIBTV_DIRECTOR_COMMAND_HISTORY_DELETE_CONTRACT.md`](research/LIBTV_DIRECTOR_COMMAND_HISTORY_DELETE_CONTRACT.md) | [`LIBTV_DIRECTOR_CURRENT_VERIFIER_MANIFEST.md`](research/LIBTV_DIRECTOR_CURRENT_VERIFIER_MANIFEST.md)、[`LIBTV_FIXTURE_CATALOG.md`](research/LIBTV_FIXTURE_CATALOG.md)、Batch 66-68、`DEC-040`、`LIBTV-VR-024` | Batch 67 codec 与 Batch 68 owner/session 已 focused pass；下一步拆 authored/runtime，再做 history/delete。不要把 sync owner isolation 当 async/persistence complete，不把 StoryAI schema 当 source fact；每轮跑 Batch 67 + 68 + Batch 59 |
