...
| 修改 LibTV graph/edge/history | [`LIBTV_GRAPH_TRANSACTION_CATALOG.md`](research/LIBTV_GRAPH_TRANSACTION_CATALOG.md)、[`LibTVGraphConnection.contract.md`](research/components/LibTVGraphConnection.contract.md)、[`LibTVGraphDocument.contract.md`](research/components/LibTVGraphDocument.contract.md)、[`ARCHITECTURE.md`](ARCHITECTURE.md)、[`LAYERS.md`](LAYERS.md) | [`LIBTV_FIXTURE_CATALOG.md`](research/LIBTV_FIXTURE_CATALOG.md)、[`LIBTV_VERIFIER_REPLACEMENT_MAP.md`](research/LIBTV_VERIFIER_REPLACEMENT_MAP.md)、相关 Batch `PLAN.md`/`IMPLEMENTATION.md` | 保持 edge/Handle 视觉；连接 reject/unknown 零 mutation；history 深隔离但排除 viewport/selection；portable load versioned/strict/zero-partial；copy 仍单独设计 |
