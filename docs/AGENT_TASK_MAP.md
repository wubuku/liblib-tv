...
| 修改 LibTV graph/edge/history | [`LIBTV_GRAPH_TRANSACTION_CATALOG.md`](research/LIBTV_GRAPH_TRANSACTION_CATALOG.md)、[`LibTVGraphConnection.contract.md`](research/components/LibTVGraphConnection.contract.md)、[`ARCHITECTURE.md`](ARCHITECTURE.md)、[`LAYERS.md`](LAYERS.md) | [`LIBTV_FIXTURE_CATALOG.md`](research/LIBTV_FIXTURE_CATALOG.md)、[`LIBTV_VERIFIER_REPLACEMENT_MAP.md`](research/LIBTV_VERIFIER_REPLACEMENT_MAP.md)、相关 Batch `PLAN.md`/`IMPLEMENTATION.md` | 保持 edge flow effect 和 Handle；连接先 normalize/validate，reject/unknown 对 graph/selection/history/model 零 mutation；snapshot/copy 仍单独设计 |
