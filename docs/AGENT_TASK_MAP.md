...
| 修改 LibTV graph/edge/history | [`LIBTV_GRAPH_TRANSACTION_CATALOG.md`](research/LIBTV_GRAPH_TRANSACTION_CATALOG.md)、[`ARCHITECTURE.md`](ARCHITECTURE.md)、[`LAYERS.md`](LAYERS.md) | 相关 Batch `PLAN.md`/`IMPLEMENTATION.md`、`canvasStore` 专项合同 | 保持 edge flow effect、Handle 和 atomic history 语义；先定义 guard、delta、selection、snapshot 和 redo 边界 |
