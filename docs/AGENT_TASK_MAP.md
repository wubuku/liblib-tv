...
| 研究 StoryAI / 修改 Director Desk | [`research/storyai-3d-director-desk-2026-08-27/README.md`](research/storyai-3d-director-desk-2026-08-27/README.md)、[`PROGRESS_AUDIT_2026-08-27.md`](research/storyai-3d-director-desk-2026-08-27/PROGRESS_AUDIT_2026-08-27.md) | [`BORROWING_DECISION_MATRIX.md`](research/storyai-3d-director-desk-2026-08-27/BORROWING_DECISION_MATRIX.md)、[`NEXT_RESEARCH_AND_IMPLEMENTATION_ROADMAP.md`](research/storyai-3d-director-desk-2026-08-27/NEXT_RESEARCH_AND_IMPLEMENTATION_ROADMAP.md)、[`EVIDENCE_MATRIX.md`](research/storyai-3d-director-desk-2026-08-27/EVIDENCE_MATRIX.md)、[`research/components/COVERAGE_MATRIX.md`](research/components/COVERAGE_MATRIX.md)、对应 Batch 34-50/59/67-95 | StoryAI 是领域机制启发，不是 LibTV 视觉/行为真相；功能深度已高于上游时优先补 project/history/resource/verification 底座；Batch 95 的画布图片到 Director 环境预览仍是 clone-owned session projection；没有用户编码授权时停在研究与合同；未经批准不移动 submodule |
| 实施 Director 可靠性底座 | [`LIBTV_DIRECTOR_PROJECT_SESSION_AUTHORITY_CONTRACT.md`](research/LIBTV_DIRECTOR_PROJECT_SESSION_AUTHORITY_CONTRACT.md)、[`LIBTV_DIRECTOR_COMMAND_HISTORY_DELETE_CONTRACT.md`](research/LIBTV_DIRECTOR_COMMAND_HISTORY_DELETE_CONTRACT.md) | [`LIBTV_DIRECTOR_CURRENT_VERIFIER_MANIFEST.md`](research/LIBTV_DIRECTOR_CURRENT_VERIFIER_MANIFEST.md)、[`LIBTV_FIXTURE_CATALOG.md`](research/LIBTV_FIXTURE_CATALOG.md)、[`liblib-canvas-batch96-2026-08-29/`](research/liblib-canvas-batch96-2026-08-29/README.md)、Batch 66-96、`DEC-040`、`DEC-041`、`DEC-043`、`DEC-044`、`DEC-045`、`DEC-046`、`LIBTV-VR-024` | Batch 67 codec、68 owner/session、69 authored/runtime、70 command/history、71/78 pointer lifecycle、72 reference-aware delete、73 Director async authority、74 browser-local persistence、75 same-project clipboard remap、76 all-canvas owner reachability、79 whole-project duplicate、80 durable tombstone/storage/resource cleanup、81 strict import/export、82 finite local resource materialization、83 command feedback projection、84 lock/editability、85 selection/CRUD、86 transform context/pointer cleanup、87 restore-selection、88 selection/timeline/TransformControls authority、89 scene-settings/add-camera discoverability、90 project/session diagnostics + scene semantic command、91 object/camera/group command boundary、92 local resource lifecycle/session lease、93 final desktop/mobile/cross-batch regression、94 workspace/drawer focus containment、95 canvas-media host handoff 和 96 multi-camera/Shot authoring 已 focused pass；后续若再立项仍需迁移剩余 direct writers、ordinary canvas async/persistence、生产级 asset/resource provider 或 source-exact Director evidence，不把 Director pass 当普通画布/backend/source parity |
