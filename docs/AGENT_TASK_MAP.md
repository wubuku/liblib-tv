...
| 实施 Director 可靠性底座 | [`LIBTV_DIRECTOR_PROJECT_SESSION_AUTHORITY_CONTRACT.md`](research/LIBTV_DIRECTOR_PROJECT_SESSION_AUTHORITY_CONTRACT.md)、[`LIBTV_DIRECTOR_COMMAND_HISTORY_DELETE_CONTRACT.md`](research/LIBTV_DIRECTOR_COMMAND_HISTORY_DELETE_CONTRACT.md) | [`LIBTV_DIRECTOR_CURRENT_VERIFIER_MANIFEST.md`](research/LIBTV_DIRECTOR_CURRENT_VERIFIER_MANIFEST.md)、[`LIBTV_FIXTURE_CATALOG.md`](research/LIBTV_FIXTURE_CATALOG.md)、Batch 66/67、`DEC-040`、`LIBTV-VR-024` | Batch 67 已完成 V1 strict codec；下一步从 owner registry/session lifecycle 开始，再拆 authored/runtime 和 history/delete。不要把 snapshot adapter 当 store authority，不接真实 persistence，不把 StoryAI schema 当 source fact；每轮跑 Batch 67 pure verifier + Batch 59 browser smoke |
