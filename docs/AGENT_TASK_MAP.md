...
| 实施 Director 可靠性底座 | [`LIBTV_DIRECTOR_PROJECT_SESSION_AUTHORITY_CONTRACT.md`](research/LIBTV_DIRECTOR_PROJECT_SESSION_AUTHORITY_CONTRACT.md)、[`LIBTV_DIRECTOR_COMMAND_HISTORY_DELETE_CONTRACT.md`](research/LIBTV_DIRECTOR_COMMAND_HISTORY_DELETE_CONTRACT.md) | [`LIBTV_DIRECTOR_CURRENT_VERIFIER_MANIFEST.md`](research/LIBTV_DIRECTOR_CURRENT_VERIFIER_MANIFEST.md)、[`LIBTV_FIXTURE_CATALOG.md`](research/LIBTV_FIXTURE_CATALOG.md)、[`liblib-canvas-batch79-2026-08-28/`](research/liblib-canvas-batch79-2026-08-28/README.md)、Batch 66-79、`DEC-040`、`DEC-041`、`DEC-043`、`DEC-044`、`DEC-045`、`LIBTV-VR-024` | Batch 67 codec、68 owner/session、69 authored/runtime、70 command/history、71/78 pointer lifecycle、72 reference-aware delete、73 Director async authority、74 browser-local persistence、75 same-project clipboard remap、76 all-canvas owner reachability 与 79 whole-project duplicate 已 focused pass；下一步应先研究 durable tombstone/storage/resource cleanup 或 strict import/export，不把 Director pass 当普通画布/backend/source parity；每轮跑 current Director gates + changed-slice verifier |
