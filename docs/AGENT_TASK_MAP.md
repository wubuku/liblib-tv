...
| 实施 Director 可靠性底座 | [`LIBTV_DIRECTOR_PROJECT_SESSION_AUTHORITY_CONTRACT.md`](research/LIBTV_DIRECTOR_PROJECT_SESSION_AUTHORITY_CONTRACT.md)、[`LIBTV_DIRECTOR_COMMAND_HISTORY_DELETE_CONTRACT.md`](research/LIBTV_DIRECTOR_COMMAND_HISTORY_DELETE_CONTRACT.md) | [`LIBTV_DIRECTOR_CURRENT_VERIFIER_MANIFEST.md`](research/LIBTV_DIRECTOR_CURRENT_VERIFIER_MANIFEST.md)、[`LIBTV_FIXTURE_CATALOG.md`](research/LIBTV_FIXTURE_CATALOG.md)、Batch 66-75、`DEC-040`、`DEC-041`、`DEC-043`、`LIBTV-VR-024` | Batch 67 codec、Batch 68 owner/session、Batch 69 authored/runtime、Batch 70 command/history、Batch 71 pointer lifecycle、Batch 72 reference-aware delete、Batch 73 Director async authority、Batch 74 browser-local persistence 与 Batch 75 same-project clipboard remap 已 focused pass；下一步优先 inactive-owner/source deletion reconciliation 或 whole-project duplicate，再处理 ordinary canvas persistence 和真实资源。不要把 Director pass 当普通画布/backend/source parity；每轮跑 Batch 67-75 + Batch 59 |
