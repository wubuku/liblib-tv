...
当前专项 verifier 覆盖 Batch 4-33、35-50；Batch 34 是 research-only，Batch 48 的本地模型 workflow、Batch 49 的 viewport gizmo 和 Batch 50 的 workspace shell/keyboard workflow 已形成有界 recorded pass。Batch 34 不应被隐式纳入脚本循环。
