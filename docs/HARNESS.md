...
| LibTV behavior | `python3 scripts/verify-liblib-batch4.py` ... `batch31.py` | script-specific assertions and no console errors |
...
```bash
for script in scripts/verify-liblib-batch{4..31}.py; do
