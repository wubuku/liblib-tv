...
| LibTV behavior | `python3 scripts/verify-liblib-batch4.py` ... `batch37.py` | script-specific assertions and no console errors |
...
```bash
for script in scripts/verify-liblib-batch{4..37}.py; do
