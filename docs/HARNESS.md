...
| LibTV behavior | `python3 scripts/verify-liblib-batch4.py` ... `batch36.py` | script-specific assertions and no console errors |
...
```bash
for script in scripts/verify-liblib-batch{4..36}.py; do
