...
- [`research/LIBTV_DIRECTOR_CURRENT_VERIFIER_MANIFEST.md`](research/LIBTV_DIRECTOR_CURRENT_VERIFIER_MANIFEST.md)：Director 17 个历史 verifier 的 current gate、merge candidate、historical-only 分级与 `LIBTV-VR-024` 入口。
