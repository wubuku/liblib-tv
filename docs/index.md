...
- [`research/liblib-canvas-batch139-2026-09-07/`](research/liblib-canvas-batch139-2026-09-07/)：顶栏 积分超市/积分余额 拆分（源站顺序对齐）。
- [`research/liblib-canvas-batch141-2026-09-07/`](research/liblib-canvas-batch141-2026-09-07/)：视频模型菜单全量目录落地（35 项采样校准）。
...
- [`research/tdcanvas-2026-09-26/`](research/tdcanvas-2026-09-26/README.md)：AICoderTudou/TDCanvas 桌面端 AI 无限画布锁定提交 `16b3127`（v0.14.0）的深度源码调研；含手写画布内核、local-first 持久化、生成任务状态机、Agent 通道与插件系统、上游归属审计与交互目录。
