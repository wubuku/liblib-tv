...
- [`research/liblib-canvas-batch61-2026-08-27/`](research/liblib-canvas-batch61-2026-08-27/)：下一轮 React Flow whole-batch change routing、current-snapshot transport、edge selection owner 和 `LIBTV-VR-016` 实施规划。
