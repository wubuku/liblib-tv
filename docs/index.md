...
- [`research/LIBTV_DIRECTOR_CURRENT_VERIFIER_MANIFEST.md`](research/LIBTV_DIRECTOR_CURRENT_VERIFIER_MANIFEST.md)：Director 历史 browser verifier、Batch 67-87 current reliability gates、merge candidate/historical-only 分级与 `LIBTV-VR-024` 入口。
